...
module.exports = function Dimensions() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      retryCount = _ref$retryCount === undefined ? 4 : _ref$retryCount,
      _ref$retryTimeout = _ref.retryTimeout,
      retryTimeout = _ref$retryTimeout === undefined ? 250 : _ref$retryTimeout;
      ...
      function DimensionsHOC() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = DimensionsHOC.__proto__ || Object.getPrototypeOf(DimensionsHOC)).call.apply(_ref2, [this].concat(args))), _this), _this.state = {}, _this.updateDimensions = function (retries) {
          ...
          if (containerWidth === 0 || containerHeight === 0) {
            ...
            if (retries > 0) {
              setTimeout(function () {
                return _this.updateDimensions(retries - 1);
              }, retryTimeout);
            }
          }
      ...
      _createClass(DimensionsHOC, [{
        ...
        value: function render() {
          ...
          return React.createElement(
            ...
            !(containerWidth || containerHeight) ? null : React.createElement(ComposedComponent, _extends({}, this.state, this.props, {
